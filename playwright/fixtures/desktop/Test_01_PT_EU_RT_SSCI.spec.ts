...
const flowName = 'Test_01_PT_EU_RT_SSCI';
...
test.describe(flowName, () => {
    ...
    test('Initial Page', async() => {
        const initialPage = new InitialPage(testPage,page);
        await initialPage.selectFlightsByDefault(flowName,'TC01-initialPage',compare);
    });
