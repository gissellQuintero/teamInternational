...
import locators  from './PurchasePageLocator';
export class PurchasePage extends commonPage{
    ...
    public async  enterCardDetails(flowName:string,screenshotTitle:string,compare:boolean) {
        ...
        await this.page.type(locators.CC_Name, (this.testPage.getValue('cardHolderName')));
    ...
    public async enterBillingDetails(flowName:string,screenshotTitle: string,compare:boolean) {
       
        await this.page.click(locators.Country);
        //console.log("Country in payment page",await this.page.click(locators.Country));
    ...
    public async enterDebitDetails(flowName: string, screenshotTitle: string, compare: boolean) {
    ...
    public async enterInternationalCardDetails(flowName: string, screenshotTitle: string, compare: boolean) {
        const cardInfo: string[] = this.testPage.getValue('cardInfo').split(',');
    ...
    public async enterCardholderInformation(flowName: string, screenshotTitle: string, compare: boolean) {
    ...
    public async enterInternationalBillingDetails(flowName:string,screenshotTitle: string,compare:boolean) {
    ...
    public async enterCardDetailsCPD(flowName: string, arg1: string, compare: boolean) {
       const cardInfo: string[] = this.testPage.getValue('cardInfo').split(',');
    ...
    public async enterCardholderInformationCPD(flowName: string, screenshotTitle: string, compare: boolean) {
        const cardHolderName = this.testPage.getValue("cardHolderName");
        const cardHolderSurname = this.testPage.getValue("cardHolderSurname");
        const cardHolderIdNumber = this.testPage.getValue("cardHolderIdNumber");
        const cardHolderEmail = this.testPage.getValue("cardHolderEmail");
    ...
    public async enterInternationalBillingDetailsCPD(flowName:string,screenshotTitle: string,compare:boolean) {
        const billingAddressCity = this.testPage.getValue("City");
        const billingAddressAddress = this.testPage.getValue("Address");
