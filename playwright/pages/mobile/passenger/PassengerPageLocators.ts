export default  {
    ...
    SLC_GenderSelect:'[data-test="TA-tp-male"]',
    SLC_Nationality:'[data-test="TA-tp-Nationality"]',
    SLC_NationalitySelec:'[data-test="TA-tp-Colombia"]',
    SLC_MonthAditional:'[data-test="TA-tp-month"]',
    ...
    Email:'(//input[@id="mat-input-8"])',
    Phone: '(//input[@id="mat-input-9"])',
    BTN_Continue: '(//button[@class="btn-primary continue-btn"])[1]',
