...
export class PassengerPage extends commonPage{
    ...
    public async fillOutPassengerInformation(flowName:string,screenshotTitle:string, compare:boolean) {
        ...
        for(let i = 0; i < nbAdult; i++){
            ...
            await this.page.type(locators.TXT_FirstNameMobile,'Adult');
            await this.page.type(locators.TXT_LastNameMobile,'Adult');
    ...
    public async enterSpecialFeatures(flowName: string, screenshotTitle: string, compare: boolean) {
        ...
        {
            await this.page.click(locators.CHKBOX_LifeMilesMobile);
            await this.page.type(locators.TXT_FrequentTravelerNumMobile,'98765461');
        ...
        {
            await this.page.click(locators.CHKBOX_SpecialAssitanceMobile);
